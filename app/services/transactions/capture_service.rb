  ...
  class CaptureService
    ...
    def call
      ActiveRecord::Base.transaction do
        ...
        referenced_authorize.update!(status: "captured") if transaction.approved? && referenced_authorize
    ...
    # Scoped to the calling merchant, so one merchant can't capture another's authorization.
